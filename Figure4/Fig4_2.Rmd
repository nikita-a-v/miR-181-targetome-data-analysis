...
#RNA
RNA8w <- RNA
RNA8w[RNA8w$MREtype == "seed_7mer_m8" & RNA8w$wobble == "Canonical", "MREtype"] <- "7mer_m8 AA"
RNA8w[RNA8w$MREtype == "seed_7mer_m8" & RNA8w$wobble == "Non-Canonical", "MREtype"] <- "7mer_m8 AU"
table(RNA8w$MREtype)
...
#RPF
RPF8w <- RPF
RPF8w[RPF8w$MREtype == "seed_7mer_m8" & RPF8w$wobble == "Canonical", "MREtype"] <- "7mer_m8 AA"
RPF8w[RPF8w$MREtype == "seed_7mer_m8" & RPF8w$wobble == "Non-Canonical", "MREtype"] <- "7mer_m8 AU"
table(RPF8w$MREtype)
...
#TE
TE8w <- TE
TE8w[TE8w$MREtype == "seed_7mer_m8" & TE8w$wobble == "Canonical", "MREtype"] <- "7mer_m8 AA"
TE8w[TE8w$MREtype == "seed_7mer_m8" & TE8w$wobble == "Non-Canonical", "MREtype"] <- "7mer_m8 AU"
table(TE8w$MREtype)
...
#MS
MS8w <- MS
MS8w[MS8w$MREtype == "seed_7mer_m8" & MS8w$wobble == "Canonical", "MREtype"] <- "7mer_m8 AA"
MS8w[MS8w$MREtype == "seed_7mer_m8" & MS8w$wobble == "Non-Canonical", "MREtype"] <- "7mer_m8 AU"
table(MS8w$MREtype)
...
#RNA
RNA8w <- RNA
RNA8w[RNA8w$MREtype == "seed_6mer" & RNA8w$wobble == "Canonical", "MREtype"] <- "6mer AA"
RNA8w[RNA8w$MREtype == "seed_6mer" & RNA8w$wobble == "Non-Canonical", "MREtype"] <- "6mer AU"
table(RNA8w$MREtype)
...
#RPF
RPF8w <- RPF
RPF8w[RPF8w$MREtype == "seed_6mer" & RPF8w$wobble == "Canonical", "MREtype"] <- "6mer AA"
RPF8w[RPF8w$MREtype == "seed_6mer" & RPF8w$wobble == "Non-Canonical", "MREtype"] <- "6mer AU"
table(RPF8w$MREtype)
...
#TE
TE8w <- TE
TE8w[TE8w$MREtype == "seed_6mer" & TE8w$wobble == "Canonical", "MREtype"] <- "6mer AA"
TE8w[TE8w$MREtype == "seed_6mer" & TE8w$wobble == "Non-Canonical", "MREtype"] <- "6mer AU"
table(TE8w$MREtype)
...
#MS
MS8w <- MS
MS8w[MS8w$MREtype == "seed_6mer" & MS8w$wobble == "Canonical", "MREtype"] <- "6mer AA"
MS8w[MS8w$MREtype == "seed_6mer" & MS8w$wobble == "Non-Canonical", "MREtype"] <- "6mer AU"
table(MS8w$MREtype)
...
#RNA
RNA8w <- RNA
RNA8w[RNA8w$MREtype == "seed_alt_38" & RNA8w$wobble == "Canonical", "MREtype"] <- "alt_38 AA"
RNA8w[RNA8w$MREtype == "seed_alt_38" & RNA8w$wobble == "Non-Canonical", "MREtype"] <- "alt_38 AU"
table(RNA8w$MREtype)
...
#RPF
RPF8w <- RPF
RPF8w[RPF8w$MREtype == "seed_alt_38" & RPF8w$wobble == "Canonical", "MREtype"] <- "alt_38 AA"
RPF8w[RPF8w$MREtype == "seed_alt_38" & RPF8w$wobble == "Non-Canonical", "MREtype"] <- "alt_38 AU"
table(RPF8w$MREtype)
...
#TE
TE8w <- TE
TE8w[TE8w$MREtype == "seed_alt_38" & TE8w$wobble == "Canonical", "MREtype"] <- "alt_38 AA"
TE8w[TE8w$MREtype == "seed_alt_38" & TE8w$wobble == "Non-Canonical", "MREtype"] <- "alt_38 AU"
table(TE8w$MREtype)
...
#MS
MS8w <- MS
MS8w[MS8w$MREtype == "seed_alt_38" & MS8w$wobble == "Canonical", "MREtype"] <- "alt_38 AA"
MS8w[MS8w$MREtype == "seed_alt_38" & MS8w$wobble == "Non-Canonical", "MREtype"] <- "alt_38 AU"
table(MS8w$MREtype)
