...
Targetsig <- data.frame(c("RNA", "RPF", "TE"),
                        c("Target", "Target", "Target"),
                        c(RNATargetTTest$p.value, RPFTargetTTest$p.value, TETargetTTest$p.value),
                        c(RNATargetksTest$p.value, RPFTargetksTest$p.value, TETargetksTest$p.value))
