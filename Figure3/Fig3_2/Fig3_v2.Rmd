...
avrevplot <- ggplot(arev2pdat, aes(y=calculated_ratios, x=factor(Description, levels = arev2pdat[order(arev2pdat$calculated_ratios, decreasing = T),"Description"]), size=Count, colour= p.adjust)) + geom_point() +
  theme_paper() + 
...
pdf("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/reviplot_akselect.pdf", width=8, height = 4)
avrevplot
dev.off()
```
