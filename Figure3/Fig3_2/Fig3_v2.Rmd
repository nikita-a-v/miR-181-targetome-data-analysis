...
targetecdfRPF
dev.off()
pdf("D:/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/TargetECDF_RPF_zoom.pdf", width=2*zoomfac, height = 2*zoomfac)
targetecdfRPFZ
dev.off()
...
=======
RPFnumT$BS_number[RPFnumT$BS_number > 21] <- 21
>>>>>>> melina_code5
# histogram
...
numecdfRPF
dev.off()
pdf("D:/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/NumECDF_RPF_zoom.pdf", width=2*zoomfac, height = 2*zoomfac)
numecdfRPFZ
dev.off()
...
numecdfRPF2
dev.off()
pdf("D:/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/NumECDF_RPF2_zoom.pdf", width=2*zoomfac, height = 2*zoomfac)
>>>>>>> melina_code5
numecdfRPF2Z
dev.off()
...
=======
pdf("D:/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/metagene_profile.pdf", width=2, height = 2)
>>>>>>> melina_code5
meta
dev.off()
```
...
=======
pdf("D:/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/region_majorityECDF_RPF.pdf", width=2, height = 2)
regMAJecdfRPF
dev.off()

pdf("D:/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/region_majorityECDF_RPF_zoom.pdf", width=2*zoomfac, height = 2*zoomfac)
>>>>>>> melina_code5
regMAJecdfRPFZ
dev.off()
...
pdf("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/dotplotBP.pdf", width=8, height = 12)
BPdp
dev.off()

pdf("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/dotplotMF.pdf", width=8, height = 12)
MFdp
dev.off()

pdf("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/dotplotCC.pdf", width=8, height = 12)
CCdp
dev.off()
...
write_xlsx(BPdf, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/BPdf.xlsx")
write_xlsx(MFdf, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/MFdf.xlsx")
write_xlsx(CCdf, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/CCdf.xlsx")
...
## revigo
process the output from the last panel at http://revigo.irb.hr/ 
```{r revigo}
# import 
RevigoBP <- read.table("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/Revigo_BP_Table.tsv", header = T)

#manually make dotplot

revisuper <- RevigoBP[RevigoBP$Dispensability <=0.4,]

BPdfrevi <- BPdf[BPdf$ID %in% revisuper$TermID,]
BPdfrevi <- BPdfrevi[order(BPdfrevi$p.adjust),]


write_xlsx(BPdfrevi, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/BPdfrevi.xlsx")


reviplot <- ggplot(RevigoBP, aes(y=Name, x=Uniqueness, colour=Value)) + geom_point() +
  theme_paper()
...
pdf("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/reviplot.pdf", width=4, height = 8)
reviplot
dev.off()
...
## adreas revigo
Ich habe die Liste in Revigo nochmal gemacht, Setting small (0.5), ohne p value Eingabe, SimRel(default). Dann habe ich bei einigen grossen Gruppen GOs rausgesucht, die einen sinnvollen Namen hatten. Beim Export nur die Obergruppen gewählt. Bleiben 135 übrig für den Revigo-Teil der Table Sxx. Davon habe ich bislang ca. 35 ausgewählt als irrelevant (rot). Könntest Du die Liste nach padj sortieren. Dann fallen noch einige redundante raus, die REVIGO nicht erwischt hat (mache ich wieder händisch) und der rest geht dann in Fig. 2 ein. Die Table_full beinhaltet alle GOs mit der Referenz-GO in der letzten Spalte (Vielleicht aus als Table Sxx zeigen).
```{r andreasrevigo}
#import andreas tables
arev <- read_xlsx("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/Revigo_BP_OnScreenTable_nonrelevantred.xlsx")

#remove irrelevant terms
arevr <- arev[arev$irrelevant=="no",]

#backreference with original data
arevBPdf <- BPdf[BPdf$ID %in% arevr$TermID,]

#order
arevBPdf <- arevBPdf[order(arevBPdf$p.adjust),]

write_xlsx(arevBPdf, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/Revigo_BP_OnScreenTable_nonrelevantred_sorted.xlsx")

```

Habe nochmal 32 rausgeschmissen. Bleiben ca. 70. Ich würde die Top 25 in die Main figure nehmen (geht quer statt hochkant?) und die gesamtliste als Supp. Figure. Dazu als Table wie besprochen mit 3 Reitern: a) Gesamt-GO-Ergebnis/ b) nach REVIGO (ohne Streichung)/ c) 70er--Liste.

```{r andreasrevigo2}
#andreas now further curated the list and wants to use the top 25 
arev2 <- read_xlsx("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/Revigo_BP_OnScreenTable_nonrelevantred_sorted_ak.xlsx")
...
write_xlsx(arev2pdat, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/Revigo_BP_OnScreenTable_nonrelevantred_sorted_ak_pvals.xlsx")
...
pdf("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/reviplot_akselect.pdf", width=4, height = 6)
avrevplot
dev.off()
```

## revigo unmodified
hier nochmal der unmodifizierte revigo output für die supplementary table (alte pvalues adden)
```{r revigounmod}
avrev_org <- read_xlsx("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/Revigo_BP_Table_full.xlsx")


arevorgBPdf <- BPdf[BPdf$ID %in% avrev_org$TermID,]

# export list with old pvalues
write_xlsx(arevorgBPdf, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/Revigo_BP_Table_full_pval.xlsx")
...
cp_gene_sets = msigdbr(species = "mouse", category = "C2", subcategory = "CP:REACTOME")
head(cp_gene_sets)

immune_gene_sets = msigdbr(species = "mouse", category = "C7", subcategory = "IMMUNESIGDB")
head(immune_gene_sets)

mir_gene_sets = msigdbr(species = "mouse", category = "C3", subcategory = "MIR:MIRDB")
head(mir_gene_sets)

#enrichment
msigdbr_t2g_CGP = cgp_gene_sets %>% dplyr::distinct(gs_name, entrez_gene) %>% as.data.frame()
CGPrich <- enricher(gene = l, TERM2GENE = msigdbr_t2g_CGP, universe = bg)

msigdbr_t2g_CP = cp_gene_sets %>% dplyr::distinct(gs_name, entrez_gene) %>% as.data.frame()
CPrich <- enricher(gene = l, TERM2GENE = msigdbr_t2g_CP, universe = bg)

msigdbr_t2g_immune = immune_gene_sets %>% dplyr::distinct(gs_name, entrez_gene) %>% as.data.frame()
immunerich <- enricher(gene = l, TERM2GENE = msigdbr_t2g_immune, universe = bg)

msigdbr_t2g_mir = mir_gene_sets %>% dplyr::distinct(gs_name, entrez_gene) %>% as.data.frame()
mirrich <- enricher(gene = l, TERM2GENE = msigdbr_t2g_mir, universe = bg)

#dotplots
CGPplot <- dotplot(CGPrich, showCategory=30) + ggtitle("dotplot chemical and genetic perturbations")

CPplot <- dotplot(CPrich, showCategory=30) + ggtitle("dotplot canonical pathways")

immuneplot <- dotplot(immunerich, showCategory=30) + ggtitle("dotplot immunesigdb")

mirplot <- dotplot(mirrich, showCategory=30) + ggtitle("dotplot mirdb")


pdf("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/dotplotCGP.pdf", width=8, height = 12)
CGPplot
dev.off()

pdf("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/dotplotCP.pdf", width=8, height = 12)
CPplot
dev.off()

pdf("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/dotplotimmune.pdf", width=8, height = 12)
immuneplot
dev.off()

pdf("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/dotplotmir.pdf", width=8, height = 12)
mirplot
dev.off()

#export datasets
CGPdf <- as.data.frame(CGPrich)
CPdf <- as.data.frame(CPrich)
immunedf <- as.data.frame(immunerich)
mirdf <- as.data.frame(mirrich)

write_xlsx(CGPdf, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/CGPdf.xlsx")
write_xlsx(CPdf, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/CPdf.xlsx")
write_xlsx(immunedf, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/immunedf.xlsx")
write_xlsx(mirdf, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure3/Fig3_2/mirdf.xlsx")
...
S3table <- largetframe[!duplicated(largetframe$geneID) & !is.na(largetframe$geneID),c("geneID", "geneName", "geneType")]
colnames(S3table) <- c("ID", "gene_symbol", "gene biotype")
S3table <- left_join(S3table, utr5, by="gene_symbol")
S3table <- left_join(S3table, utr3, by="gene_symbol")
S3table <- left_join(S3table, cds, by="gene_symbol")
S3table[is.na(S3table$num_5UTR),"num_5UTR"] <- 0
S3table[is.na(S3table$num_3UTR),"num_3UTR"] <- 0
S3table[is.na(S3table$num_CDS),"num_CDS"] <- 0
S3table$total_bs_number <- rowSums(S3table[,c("num_5UTR", "num_3UTR", "num_CDS")])
S3table <- left_join(S3table, RNA[,c("gene_symbol", "log2FoldChange", "padj")], by="gene_symbol")
colnames(S3table)[8:9] <- c("log2FoldChange_RNAseq", "padj_RNAseq")
S3table <- left_join(S3table, RPF[,c("gene_symbol", "log2FoldChange", "padj")], by="gene_symbol")
colnames(S3table)[10:11] <- c("log2FoldChange_RF", "padj_RF")

head(S3table)

#export

write_xlsx(S3table, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Supplementary_tables/SupplementaryTable_3_onlydat.xlsx")

# make a second tab with non coding genes
#import data
nctab <- readRDS("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Methods/mir181-enriched_binding_site_definition/2023-04-03-BS_mir181_enriched.rds")

nctabframe <- as.data.frame(nctab)
S3tab_nc <- nctabframe[!(nctabframe$geneType == "protein_coding"), c("geneID", "geneName", "geneType")]

S3tab_ncE <- as.data.frame(table(S3tab_nc$geneID))
colnames(S3tab_ncE) <- c("geneID", "total_bs_number")
S3tab_ncE <- left_join(S3tab_ncE, S3tab_nc[!duplicated(S3tab_nc$geneID),], by="geneID")
S3tab_ncE <- S3tab_ncE[,c(1,3,4,2)]

#export
write_xlsx(S3tab_ncE, "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Supplementary_tables/SupplementaryTable_3_onlydat_nc.xlsx")
