...
# readd metadata
elementMetadata(mir181_bs_tx) <- c(elementMetadata(mir181_bs_tx), elementMetadata(mir181_bs[mir181_bs_tx$xHits]))
...
mir181_bs_tx[mir181_bs_tx$start < 1,]


t <- anno[anno$geneID == "ENSMUSG00000063229"]

t[t$type=="gene"]
t[(t$type=="transcript") & t$transcript_id == "ENSMUST00000048209"]
