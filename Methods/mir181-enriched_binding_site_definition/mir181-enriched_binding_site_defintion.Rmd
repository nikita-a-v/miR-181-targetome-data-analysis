...
- Then binding sites are defined with BindingSiteFinder. The used binding site size is 7nt to match with the AGO binding site definition. The xxx plots show that 7nt fits the binding site patterns well.
