...
## plot clustered 
```{r plotsepclust}
HMAsep <- Heatmap(cframeA, cluster_columns = F, cluster_rows = F, col = hmcols1, show_row_names = F, show_row_dend = F, border = TRUE)
...
#remove cluster col
cframeAseed <- cframeAseed[,-24]
head(cframeAseed)

```

## plot clustered by sed region
```{r plotsepclustseed}
HMAseed <- Heatmap(cframeAseed, cluster_columns = F, cluster_rows = F, col = hmcols1, show_row_names = F, show_row_dend = F, border = TRUE)
