...
# ----------------------------------------
here <- here::here()
out <- paste0(here,"/Figure2/02_compare_miR_enriched_to_Ago_binding_sites/")
...
chimeric_reads <- readRDS(paste0(here,"/Figure1/02_Ago_targetome/mir_chimeric_crosslinks.rds"))
...
# AGO binding sites
# ----------------------------------------
ago_bs <- readRDS(paste0(here,"/Figure1/01_AGO_binding_site_definition/AGO_BS.rds"))
