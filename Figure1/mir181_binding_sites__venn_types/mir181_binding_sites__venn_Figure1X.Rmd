...
pdf(paste0(out, "Venn_overlaps_mirBs.pdf"), height = 3, width = 4 )
p
dev.off()
...
ggsave(p1, filename =  paste0(out, "ecdf_differntial_binding_vs_mir181BS.pdf"), width = 6, height = 7, units = "cm")
