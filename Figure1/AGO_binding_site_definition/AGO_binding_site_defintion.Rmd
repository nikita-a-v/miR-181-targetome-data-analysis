...
out <- "/Users/melinaklostermann/Documents/projects/AgoCLIP_miR181/R_github/miR181_paper/Figure1/AGO_binding_site_definition/"
...
p <- ggplot(df3, aes(y=Freq, x="", fill=GeneType)) +
  ...
  labs(y = NULL,
       x = NULL)
p
ggsave(p, filename = paste0(out, "Figure1C_bound_gene_types_AGO", Sys.Date(), ".pdf"), width = unit(8, "cm"), height = unit(6,"cm"))
