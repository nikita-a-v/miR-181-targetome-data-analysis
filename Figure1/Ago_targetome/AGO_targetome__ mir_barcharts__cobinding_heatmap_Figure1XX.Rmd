...
#Nikita out
out <- "C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure1/Ago_targetome/"
...
# Nikita source
mir_crosslinks <- list.files("C:/Users/nikit/Documents/Krueger_Lab/miReCLIP/Melina/pipe_output_22_02_14/pipe_output_22_02_14/chimeric/crosslinks/", 
                             pattern = "*.bed", recursive = TRUE, full.names = T) %>% map(~import.bed(.x, extraCols = c(Name = "character", Score="numeric", Strand="factor")))
names(mir_crosslinks) <- list.files("C:/Users/nikit/Documents/Krueger_Lab/miReCLIP/Melina/pipe_output_22_02_14/pipe_output_22_02_14/chimeric/crosslinks/", 
                             pattern = "*.bed")
...
# Nikita source
mir_imgen <- read.csv("C:/Users/nikit/Documents/Krueger_Lab/Publications/miR181_paper/Figure1/Ago_targetome/DPsets_immgen.csv")
...
ggsave(p4, filename = paste0(out, "Figure1D_Comparison_miR_expression_Imgen_nv", Sys.Date(), ".pdf"), width = unit(6, "cm"), height = unit(6,"cm"))
