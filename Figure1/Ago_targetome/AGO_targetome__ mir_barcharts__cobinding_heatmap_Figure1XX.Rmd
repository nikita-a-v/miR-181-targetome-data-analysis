...
# AGO binding sites
# ----------------------------------------
ago_bs <- readRDS("/Users/melinaklostermann/Documents/projects/AgoCLIP_miR181/R_github/miR181_paper/Methods/02_AGO_binding_site_definition/2023-04-04-BS_mir181_enriched.rds")
...
```{r n_chimeric_reads_barchart_paper, eval=FALSE, include=FALSE}
p <- p + theme_paper()
...
```{r xlsx_detected_mir, eval=FALSE, include=FALSE}
...
```{r barchart_for_paper, eval=FALSE, include=FALSE}
# save for paper
p1 <- p1 + theme_paper()
p3 <- p3 + theme_paper()
...
```{r cooccurence_heatmap, eval=FALSE, include=FALSE}
