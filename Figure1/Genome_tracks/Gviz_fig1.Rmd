...
grtrack <- GeneRegionTrack(gffframe, genome = "Mmu", chromosome = tchr, name = "Gene",  transcript = "transcript_type", symbol = "gene_name", showId=TRUE, geneSymbol=TRUE, background.title = "brown")
