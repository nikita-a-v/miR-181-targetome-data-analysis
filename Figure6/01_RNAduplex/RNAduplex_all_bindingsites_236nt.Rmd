...
pdf(file = paste0(out,"Figure6C_Heatmap_with_seed.pdf"))
...
ggsave( filename = paste0(out, "SuppFigureH_pureclip_score_per_cluster_can.pdf"), width = 6, height = 5, units = "cm")
...
ggsave( filename = paste0(out, "FigureS6E_min_free_energy_per_cluster_can.pdf"), width = 6, height = 5, units = "cm")
...
pdf(file = paste0(out,"Figure6G_Heatmap_without_seed.pdf"))
...
pdf(file = paste0(out,"Figure6E_Heatmap_without_seed.pdf"))
...
ggsave( filename = paste0(out, "SuppFigure6I_pureclip_score_per_cluster_noncan_noseed.pdf"), width = 6, height = 5, units = "cm")
...
ggsave( filename = paste0(out, "SuppFigureS6J_pureclip_score_per_cluster_noncan_partseed.pdf"), width = 6, height = 5, units = "cm")
...
ggsave( filename = paste0(out, "SuppFigureS6F_min_free_energy_per_cluster_noncan_noseed.pdf"), width = 6, height = 5, units = "cm")
...
ggsave( filename = paste0(out, "SuppFigureS6G_min_free_energy_per_cluster_noncan_partseed.pdf"), width = 6, height = 5, units = "cm")
...
ggsave( filename = paste0(out, "Figure6d_ecdf_clusters_can.pdf"), width = 5, height = 8, units = "cm")
...
ggsave( filename = paste0(out, "Figure6H_ecdf_clusters_nocan_noseed.pdf"), width = 9, height = 5, units = "cm")
...
ggsave( filename = paste0(out, "Figure6H_ecdf_clusters_nocan_noseed_zoomIn.pdf"), width = 9, height = 5, units = "cm")
...
ggsave( filename = paste0(out, "Figure6F_ecdf_clusters_nocan_partseed.pdf"), width = 7, height = 5, units = "cm")
...
ggsave( filename = paste0(out, "Figure6F_ecdf_clusters_nocan_partseed_zoomIns.pdf"), width = 7, height = 5, units = "cm")
