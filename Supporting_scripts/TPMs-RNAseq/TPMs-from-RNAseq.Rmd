...
# settings
# ----------------------------------------
out <- paste0(here,"/Supporting_scripts/TPMs-RNAseq/")
...
# Files
```{r}
RNAseq_read_counts <- read_csv(paste0(here,"/Figure3/01_Ribosome_profiling_pipeline/RNAadjusted_countmatrix_15112022.csv"))
